...
```{important}
For your final reports: You must include a signed declaration of originality ([*Eigenständigkeitserklärung*](https://www.uni-frankfurt.de/100361739/BSc_MSc_FAQ___April_2021.pdf?#page=4)) at the end of your report!
```
...
- Provide a **list of all AI tools** you used at the end of your report and include a disclaimer on AI use in your **Eigenständigkeitserklärung** (see {doc}`../general_information/student-guide`)
